...
# Copy SPM resource bundle next to executable (Bundle.module looks here)
if [ -d ".build/release/Voca_Voca.bundle" ]; then
    cp -R ".build/release/Voca_Voca.bundle" "$MACOS_DIR/"
    echo "Copied Voca_Voca.bundle to MacOS/"
fi
